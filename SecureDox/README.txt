...
This is because a new randomized 120 byte passphrase is created with each use. Not only is this passphrase very strong, but it also defends against one of the biggest vulnerabilities to the AES-256-CBC passphrase system which is a keylogger. This is because the passphrase is never entered manually by neither the sender or recipient.
